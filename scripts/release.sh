...
release-notes --org mattermost --repo kube-spot-termination-notice-handler --start-sha "${LATEST_RELEASE_NEXT_COMMIT_SHA}" --end-sha "${FUTURE_RELEASE_SHA}"  --output ./build/_output/docs/relnote.md --required-author "" --branch master --dependencies false
